var manifest = {
	...
	{
		type: "script",
		href: "/assets/_...404_-62da91c9.js"
	},
	{
		type: "script",
		href: "/assets/entry-client-77eb3d97.js"
	},
	{
		type: "style",
...
function getAssetsFromManifest(manifest, routerContext) {
  ...
  const links = match.reduce((r, src) => {
    r[src.href] = src.type === "style" ? ssr(_tmpl$$3, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : src.type === "script" ? ssr(_tmpl$2$1, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : undefined;
    return r;
  }, {});
...
const _tmpl$ = ["<p", ">", "</p>"],
  _tmpl$2 = ["<main", "><!--#-->", "<!--/--><h1>Hello world!</h1><!--#-->", "<!--/--><!--#-->", "<!--/--><p>Visit <a href=\"https://start.solidjs.com\" target=\"_blank\">start.solidjs.com</a> to learn how to build SolidStart apps.</p></main>"];
...
function Home() {
  ...
  return ssr(_tmpl$2, ssrHydrationKey(), escape(createComponent(Title, {
    ...
    get children() {
      return ssr(_tmpl$, ssrHydrationKey(), escape(result()));
    }
